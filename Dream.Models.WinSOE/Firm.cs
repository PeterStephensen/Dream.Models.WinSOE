...
namespace Dream.Models.WinSOE
{
    public class Firm : Agent
    {
        ...
        public ECommunicate Communicate(ECommunicate comID, object o)
        {
            ...
            switch (comID)
            {
                case ECommunicate.JobApplication:
                    ...
                    //_statistics.StreamWriterFirmApplications.WriteLineTab(_time.Now, ID, h.Productivity);
        ...
        void Management()
        {
            ...
            double wage = _statistics.PublicMarketWageTotal;
            double price = _statistics.PublicMarketPrice[_sector];
            //double wage = _expWage;
            //double price = _expPrice;
        ...
        void HumanResource()
        {
            ...
            //_vacancies_net += 0.05 * (_l_optimal - _expEmployment);
        ...
        void ReportToStatistics()
        {
            if (_report & !_settings.SaveScenario)
            {
                _statistics.StreamWriterFirmReport.WriteLineTab(_year, ID, _phi, _l_primo, _y_primo, _s_primo,
                      ...
                      _expSales,  _expApplications * _expAvrProd, _expQuitters * _expAvrProd, _expAvrProd, _statistics.PublicMarketPrice[_sector], 
                      _statistics.PublicMarketWage[_sector], _expPotentialSales, _expEmployment, _l_markup, _relative_price, _relative_wage, _expVacancies, 
                      _age, _stock, _firings);
